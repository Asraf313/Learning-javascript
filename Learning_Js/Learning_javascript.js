...
var a = 20;
var b = 40;
var c = a++;  // Increment operators
var d = b--;  // Decrement operators
console.log(a);
console.log(c);
console.log(b);
console.log(d);
...
var e = 20;
var f = 40;
var g = ++e; // Increment operators
var h = --f;  // Decrement operators
console.log(e);
console.log(f);
console.log(g);
console.log(h);
...
var studentName = "Mohamed Asraf R"; // String
var age = 25; // Number
...
var myname = Myname(); // Stored the return value in a variable
console.log(myname);

// If else statement:
var rain = true;
if (rain == true) {
    console.log("I need to umbrella");
}
else {
    console.log("I don't need umbrella");
}

// Print student mark list statement
var Student_name = "Mohamed Asraf R";
var Class = "10th standard";
var Register_no = 858101;
var Tamil = 80;
var English = 50;
var Maths = 35;
var Science = 75;
var Social_science = 90;
var Total = Tamil + English + Maths + Science + Social_science;
...
student_marklist("Social Science", Social_science);
...
newElement2.textContent = "Hello, I am prepended using JavaScript!";
container2.prepend(newElement2);
console.log(container2);

// InsertAdjacentHTML:
var container3 = document.getElementById("Container3");
container3.insertAdjacentHTML("afterend", "<h3>Hello, I am added using insertAdjacentHTML!</h3>");
